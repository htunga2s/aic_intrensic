...
All the environments are registered in the `intrinsic_task` extension. They start
...
import intrinsic_task.tasks  # noqa: F401


def main():
    """Print all environments registered in `intrinsic_task` extension."""
