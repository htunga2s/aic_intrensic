...
# source/intrinsic_task/intrinsic_task/tasks/manager_based/intrinsic_task/Intrinsic_assets/assets
ASSETS_PATH = os.path.join(EXTENSION_PATH, "tasks/manager_based/intrinsic_task/Intrinsic_assets", "assets") 
...
class ExampleExtension(omni.ext.IExt):
    ...
    def reset_orient_op_type(self):
        ...
        quatd_val = Gf.Quatd(
            float(quatf_val.GetReal()),
            Gf.Vec3d(*quatf_val.GetImaginary())
        )
